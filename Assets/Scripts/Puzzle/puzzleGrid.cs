...
public class puzzleGrid : MonoBehaviour
{
    ...
    public void InitPuzzleGrid(int width , int height , float offset , int minPuzzleToGather)
    {
        this.width = width;
        this.height = height;
        this.offset = offset;
        this.minPuzzleToGather = minPuzzleToGather;
    ...
    public bool UsedTool(List<int> TypesToGather)
    {
        int ifWeGetSome = 0;
